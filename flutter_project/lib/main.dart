...
import 'package:flutter_project/widget_life.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: <String, WidgetBuilder> {
        '/life': (BuildContext context) => WidgetLifeDemo1()
      },
      title: 'Flutter Demo',
      theme: ThemeData(
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(_privateString,style: TextStyle(
              fontSize: 20.0,
              color: Colors.red
            ),),
            ...
            FlatButton(
              color: Colors.red,
                ...
                child: Text('跳转WidgetLifeDemo',style: TextStyle(
                  color: Colors.white,
                  fontSize: 20.0
                ),))
          ],
